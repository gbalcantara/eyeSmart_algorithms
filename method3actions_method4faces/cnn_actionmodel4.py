...
plot_model(classifier, to_file='cnn_actionmodel4.png', show_shapes=True, show_layer_names=True)
...
with open("actionmodel4_5action_mix.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
classifier.save_weights("actionmodel4_5action_mix.h5")
