...
training_set = train_datagen.flow_from_directory(
	'datasetaction5/mixtrain',
	target_size=(64,64),
	batch_size=32,
	class_mode='categorical')

test_set = test_datagen.flow_from_directory(
	'datasetaction5/mixtest',
	target_size=(64,64),
	batch_size=32,
	class_mode='categorical')
...
plot_model(classifier, to_file='cnn_actionmodel3.png', show_shapes=True, show_layer_names=True)
...
with open("actionmodel3_5action_mix.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
classifier.save_weights("actionmodel3_5action_mix.h5")
